...
/**
 * LgtWaybillGoodsTemplate entity. @author MyEclipse Persistence Tools
 */

public class LgtWaybillGoodsTemplate implements java.io.Serializable {
	...
	/** default constructor */
	public LgtWaybillGoodsTemplate() {
		lid = "";
		templateName = "";
		shippingNoteNo = "";
		commodityName = "";
	...
	/** full constructor */
	public LgtWaybillGoodsTemplate(String templateName, String shippingNoteNo,
			String commodityName, String packaging, String lnumber,
			String weight, String volume, String specification,
			String shippingNoteId, String founder, Date foundationDate,
